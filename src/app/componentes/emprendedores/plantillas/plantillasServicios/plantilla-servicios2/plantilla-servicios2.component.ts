...
@Component({
  selector: 'app-plantilla-servicios2',
  standalone: true,
  imports: [HttpClientModule, MatButtonModule, MatCardModule],
  templateUrl: './plantilla-servicios2.component.html',
  styleUrl: './plantilla-servicios2.component.scss'
})
export class PlantillaServicios2Component implements OnInit, AfterViewInit{
